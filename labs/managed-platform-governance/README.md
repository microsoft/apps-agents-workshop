...
# Managed Governance: Environment Strategy & Governance
...
| Lab | Description |
|-----|-------------|
| [Create an environment group](environment-strategy-and-governance-modules/01-create-environment-group.md) | Create the Safe Innovation Zone and understand environment groups |
| [Configure connector policy](environment-strategy-and-governance-modules/02-configure-connector-policy.md) | Set up advanced connector policies to control which connectors makers can use |
| [Configure sharing limits](environment-strategy-and-governance-modules/03-configure-sharing-limits.md) | Restrict how broadly canvas apps can be shared |
| [Configure additional rules](environment-strategy-and-governance-modules/04-configure-additional-rules.md) | Set up solution checker, usage insights, backup retention, and apply all rules |
| [Configure maker welcome](environment-strategy-and-governance-modules/05-configure-maker-welcome.md) | Embed onboarding guidance directly in Power Apps |
| [Configure environment routing](environment-strategy-and-governance-modules/06-configure-environment-routing.md) | Route new makers to the Safe Innovation Zone |
| [Test sharing limits](environment-strategy-and-governance-modules/07-test-sharing-limits.md) | Verify that sharing limits and routing work as expected |
| [Configure default pipeline](environment-strategy-and-governance-modules/08-configure-default-pipeline.md) | Set up a deployment pipeline for the Safe Innovation Zone |
| [Clean up default environment](environment-strategy-and-governance-modules/09-clean-up-default-environment.md) | Migrate apps out of the default environment |
